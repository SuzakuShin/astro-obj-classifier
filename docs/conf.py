# -*- coding: utf-8 -*-
#
# astro-obj-classifier documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'astro-obj-classifier'
...
htmlhelp_basename = 'astro-obj-classifierdoc'
...
latex_documents = [
    ('index',
     'astro-obj-classifier.tex',
     u'astro-obj-classifier Documentation',
     u"Suzaku-Shin", 'manual'),
]
...
man_pages = [
    ('index', 'astro-obj-classifier', u'astro-obj-classifier Documentation',
     [u"Suzaku-Shin"], 1)
]
...
texinfo_documents = [
    ('index', 'astro-obj-classifier', u'astro-obj-classifier Documentation',
     u"Suzaku-Shin", 'astro-obj-classifier',
